...
task = Task.init(project_name='Textline detection', task_name='3rd run')
...
class Trainer(BaseTrainer):
    ...
    def _val_epoch(self, epoch):
        ...
        self.writer.add_scalar('VAL/LOSS/loss_all', loss_all, self.global_step)
        self.writer.add_scalar('VAL/LOSS/loss_tex', loss_tex, self.global_step)
        self.writer.add_scalar('VAL/LOSS/loss_ker', loss_ker, self.global_step)
        self.writer.add_scalar('VAL/LOSS/loss_agg', loss_agg, self.global_step)
        self.writer.add_scalar('VAL/LOSS/loss_dis', loss_dis, self.global_step)
        self.writer.add_scalar('VAL/ACC_IOU/acc', acc, self.global_step)
        self.writer.add_scalar('VAL/ACC_IOU/iou_text', iou_text, self.global_step)
        self.writer.add_scalar('VAL/ACC_IOU/iou_kernel', iou_kernel, self.global_step)
